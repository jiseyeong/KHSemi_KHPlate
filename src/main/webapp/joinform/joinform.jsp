...
<body>
	<form id="frm" action="/JoinMembers.members">
		<table>
			<tr>
				<th colspan="3" style="text-align: center;">SignUp Info</th>
			</tr>
			<tr>
				<td>ID</td>
			...
			<tr>
				...
				<td><input type="text" name="address1" id="address1"
					placeholder="ROAD NAME ADDRESS"></td>
			</tr>
			<tr>
				<td>ADDRESS2</td>
			...
			<tr>
				<td colspan="3" style="text-align: center;">
					<button type=submit id="toJoin">Sign Up</button>
	...
	<script>
		...
		$("#pw2").on("keyup", function() { //비밀번호 일치여부 표시
			if ($("#pw2").val() == $("#pw1").val()) {
				$("#pwCheck").html("OK :)").css("color", "dodgerblue");
			} else {
				$("#pwCheck").html("NO :(").css("color", "red");
			}
		});
