  ...
  <div class="container">
    ...
    <form name="form1" class="box" onsubmit="return checkStuff()">
      ...
      <h5>오늘은 뭐 먹지?</h5>
        ...
        <input type="password" name="password" placeholder="PW" id="pw" autocomplete="off">
        <label>
          <input type="checkbox">
          <span></span>
          <small class="rmb">ID 기억하기</small>
        </label>
        <a href="#" class="forgetpass">비밀번호 찾기</a>
        <input type="submit" value="Sign in" class="btn" id="signupBtn">
        <input type="submit" value="KAKAO" class="btn" id="kakaoBtn">
        <input type="submit" value="NAVER" class="btn" id="naverBtn">
      </form>
