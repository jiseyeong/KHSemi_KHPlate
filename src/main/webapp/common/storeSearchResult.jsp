			...
			<div class="main_layout">
				<div class="search_category_layout">
					...
					<div class="show_filterForm_layout">
						<button id="show_filterForm_btn" class="navbar-toggler"
										...
										<div class="cost_average">
											...
											<div class="filter_cost">
												<input type="text" id="cost_set" name="cost_range"
													...
													id="range" class="form-range" min="0" max="4" step="1"
													onchange="SetValue()">
  ...
  <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z"/>
											...
											<div class="btn_inner_layout">
												<svg xmlns="http://www.w3.org/2000/svg" width="16"
													height="16" fill="currentColor" class="sort_apply_btn"
													id="apply_btn" viewBox="0 0 16 16">
								...
								<div class="img_layout">
									...
									<div class="restaurant_addFavorite">
										<input type="text" name="addFavorite_storeID"
											value="${i.storeID}" style="display: none;"> <input
											type="text" name="addFavorite_userno"
