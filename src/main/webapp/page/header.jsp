	...
	<div class="row header m-0" style="margin-bottom: 70px;">
		...
		<div class="col-12 col-lg-6  d-flex search">
			<form id=searchForm action="/searchStoreBySearchBox.store"
				method="get" class="form d-flex" onsubmit="return false;">
				<select size="1" id="searchCheck" class="nanum-gothic"
					name="searchSelect">
					<option value="1">맛집</option>
					<option value="2">블로그</option>
				</select> <input type="text" name="searchedBy" value="mainSearch"
					style="display: none;"> <input type="search" id="searchBox"
					name="search">
				<button type="button" id="searchBtn" style="color: white;"
